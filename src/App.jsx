      ...
      <div style={{ flex: 1, display: "flex", flexDirection: isMobile ? "column" : "row", overflow: "hidden", minHeight: 0 }}>
        ...
        <div style={{ flex: 1, display: "flex", flexDirection: "column", overflow: "hidden", minHeight: 0 }}>
          ...
          >
            ...
            {/* 交易 */}
            {sideTab === "journal" && (
              <TradeJournal coins={coins} defaultSymbol={selected?.symbol} onNotify={pushNotif} settings={settings} recs={recs} anomalies={anomalies} explosive={explosive} onSetAlert={(t) => { addPriceAlert(t.symbol, t.entry, t.direction === "long" ? "below" : "above"); pushNotif({ symbol: t.symbol, signal: `已設到價提醒 @ ${t.entry}`, color: "#f0b90b", confidence: 0 }); }} />
            )}
